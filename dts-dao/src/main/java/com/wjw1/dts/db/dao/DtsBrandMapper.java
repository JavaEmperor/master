...
public interface DtsBrandMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsBrand selectOneByExampleSelective(@Param("example") DtsBrandExample example,
			@Param("selective") DtsBrand.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsBrand> selectByExampleSelective(@Param("example") DtsBrandExample example,
			@Param("selective") DtsBrand.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsBrand selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
