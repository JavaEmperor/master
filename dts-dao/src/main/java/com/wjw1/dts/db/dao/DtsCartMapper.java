...
public interface DtsCartMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCart selectOneByExampleSelective(@Param("example") DtsCartExample example,
			@Param("selective") DtsCart.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsCart> selectByExampleSelective(@Param("example") DtsCartExample example,
			@Param("selective") DtsCart.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCart selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
