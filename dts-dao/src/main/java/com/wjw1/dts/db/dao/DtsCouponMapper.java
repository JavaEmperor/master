...
public interface DtsCouponMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCoupon selectOneByExampleSelective(@Param("example") DtsCouponExample example,
			@Param("selective") DtsCoupon.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsCoupon> selectByExampleSelective(@Param("example") DtsCouponExample example,
			@Param("selective") DtsCoupon.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCoupon selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
