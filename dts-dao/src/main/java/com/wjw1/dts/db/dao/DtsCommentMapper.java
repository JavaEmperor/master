...
public interface DtsCommentMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsComment selectOneByExampleSelective(@Param("example") DtsCommentExample example,
			@Param("selective") DtsComment.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsComment> selectByExampleSelective(@Param("example") DtsCommentExample example,
			@Param("selective") DtsComment.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsComment selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
