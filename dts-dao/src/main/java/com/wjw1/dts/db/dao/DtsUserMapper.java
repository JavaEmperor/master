...
public interface DtsUserMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsUser selectOneByExampleSelective(@Param("example") DtsUserExample example,
			@Param("selective") DtsUser.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsUser> selectByExampleSelective(@Param("example") DtsUserExample example,
			@Param("selective") DtsUser.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsUser selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
