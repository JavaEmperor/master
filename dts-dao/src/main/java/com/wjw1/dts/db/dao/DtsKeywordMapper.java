...
public interface DtsKeywordMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsKeyword selectOneByExampleSelective(@Param("example") DtsKeywordExample example,
			@Param("selective") DtsKeyword.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsKeyword> selectByExampleSelective(@Param("example") DtsKeywordExample example,
			@Param("selective") DtsKeyword.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsKeyword selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
