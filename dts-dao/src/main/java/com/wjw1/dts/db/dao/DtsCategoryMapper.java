...
public interface DtsCategoryMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCategory selectOneByExampleSelective(@Param("example") DtsCategoryExample example,
			@Param("selective") DtsCategory.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsCategory> selectByExampleSelective(@Param("example") DtsCategoryExample example,
			@Param("selective") DtsCategory.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCategory selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") DtsCategory.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCategory selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
