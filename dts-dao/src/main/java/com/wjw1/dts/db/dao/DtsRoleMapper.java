...
public interface DtsRoleMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsRole selectOneByExampleSelective(@Param("example") DtsRoleExample example,
			@Param("selective") DtsRole.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsRole> selectByExampleSelective(@Param("example") DtsRoleExample example,
			@Param("selective") DtsRole.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsRole selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
