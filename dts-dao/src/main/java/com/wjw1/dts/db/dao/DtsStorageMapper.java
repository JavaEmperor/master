...
public interface DtsStorageMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsStorage selectOneByExampleSelective(@Param("example") DtsStorageExample example,
			@Param("selective") DtsStorage.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsStorage> selectByExampleSelective(@Param("example") DtsStorageExample example,
			@Param("selective") DtsStorage.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsStorage selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
