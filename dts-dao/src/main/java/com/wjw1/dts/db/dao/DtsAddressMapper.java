...
public interface DtsAddressMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsAddress selectOneByExampleSelective(@Param("example") DtsAddressExample example,
			@Param("selective") DtsAddress.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsAddress> selectByExampleSelective(@Param("example") DtsAddressExample example,
			@Param("selective") DtsAddress.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsAddress selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
