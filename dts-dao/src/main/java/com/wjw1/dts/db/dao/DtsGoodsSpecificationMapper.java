...
public interface DtsGoodsSpecificationMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsGoodsSpecification selectOneByExampleSelective(@Param("example") DtsGoodsSpecificationExample example,
			@Param("selective") DtsGoodsSpecification.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsGoodsSpecification> selectByExampleSelective(@Param("example") DtsGoodsSpecificationExample example,
			@Param("selective") DtsGoodsSpecification.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsGoodsSpecification selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") DtsGoodsSpecification.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsGoodsSpecification selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") DtsGoodsSpecification record,
			@Param("example") DtsGoodsSpecificationExample example);
	 ...
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") DtsGoodsSpecification record,
			@Param("example") DtsGoodsSpecificationExample example);
