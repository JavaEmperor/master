...
public interface DtsFeedbackMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsFeedback selectOneByExampleSelective(@Param("example") DtsFeedbackExample example,
			@Param("selective") DtsFeedback.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsFeedback> selectByExampleSelective(@Param("example") DtsFeedbackExample example,
			@Param("selective") DtsFeedback.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsFeedback selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") DtsFeedback.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsFeedback selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
