...
public interface DtsCollectMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCollect selectOneByExampleSelective(@Param("example") DtsCollectExample example,
			@Param("selective") DtsCollect.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsCollect> selectByExampleSelective(@Param("example") DtsCollectExample example,
			@Param("selective") DtsCollect.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsCollect selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
