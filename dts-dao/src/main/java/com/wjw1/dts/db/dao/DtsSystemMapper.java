...
public interface DtsSystemMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsSystem selectOneByExampleSelective(@Param("example") DtsSystemExample example,
			@Param("selective") DtsSystem.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsSystem> selectByExampleSelective(@Param("example") DtsSystemExample example,
			@Param("selective") DtsSystem.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsSystem selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
