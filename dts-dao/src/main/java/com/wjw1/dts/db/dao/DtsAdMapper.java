...
public interface DtsAdMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsAd selectOneByExampleSelective(@Param("example") DtsAdExample example,
			@Param("selective") DtsAd.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsAd> selectByExampleSelective(@Param("example") DtsAdExample example,
			@Param("selective") DtsAd.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsAd selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
