...
public interface DtsGoodsMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsGoods selectOneByExampleSelective(@Param("example") DtsGoodsExample example,
			@Param("selective") DtsGoods.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsGoods> selectByExampleSelective(@Param("example") DtsGoodsExample example,
			@Param("selective") DtsGoods.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsGoods selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
