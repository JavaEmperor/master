...
public interface DtsRegionMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsRegion selectOneByExampleSelective(@Param("example") DtsRegionExample example,
			@Param("selective") DtsRegion.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsRegion> selectByExampleSelective(@Param("example") DtsRegionExample example,
			@Param("selective") DtsRegion.Column... selective);
