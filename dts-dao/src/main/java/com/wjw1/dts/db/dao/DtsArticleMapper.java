...
public interface DtsArticleMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsArticle selectOneByExampleSelective(@Param("example") DtsArticleExample example,
			@Param("selective") DtsArticle.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsArticle> selectByExampleSelective(@Param("example") DtsArticleExample example,
			@Param("selective") DtsArticle.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsArticle selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
