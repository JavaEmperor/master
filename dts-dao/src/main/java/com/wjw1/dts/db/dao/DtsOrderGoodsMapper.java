...
public interface DtsOrderGoodsMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsOrderGoods selectOneByExampleSelective(@Param("example") DtsOrderGoodsExample example,
			@Param("selective") DtsOrderGoods.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsOrderGoods> selectByExampleSelective(@Param("example") DtsOrderGoodsExample example,
			@Param("selective") DtsOrderGoods.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsOrderGoods selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") DtsOrderGoods.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsOrderGoods selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
