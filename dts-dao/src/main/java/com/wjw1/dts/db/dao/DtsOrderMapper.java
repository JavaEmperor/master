...
public interface DtsOrderMapper {
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsOrder selectOneByExampleSelective(@Param("example") DtsOrderExample example,
			@Param("selective") DtsOrder.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	List<DtsOrder> selectByExampleSelective(@Param("example") DtsOrderExample example,
			@Param("selective") DtsOrder.Column... selective);
	 ...
	 * @project https://github.com/itfsw/mybatis-generator-plugin
	 */
	DtsOrder selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
